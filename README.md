...
Features include persistent memory, Discord slash commands, Gemini image understanding for attachments, guarded Minecraft RCON actions, new-player join help, member snitch reports with short timeout punishment, Discord moderation, full vacation moderation, Minecraft monitoring, optional PebbleHost/API recovery, and weekly reports.
