...
Features include persistent memory, Discord slash commands, Gemini image understanding for attachments, guarded Minecraft RCON actions, short Discord timeout moderation, Minecraft monitoring, optional webhook recovery, and weekly reports.
