...
Features include persistent memory, Discord slash commands, Gemini image/video understanding for attachments, guarded Minecraft RCON actions, new-player join help, remembered member snitch reports with media evidence and severity-based short timeout punishment, Discord moderation, full vacation moderation, Minecraft monitoring, optional PebbleHost/API recovery, and weekly reports.
