...
Features include persistent memory, Discord slash commands, Gemini image understanding for attachments, guarded Minecraft RCON actions, new-player join help, short Discord timeout moderation, full vacation moderation, Minecraft monitoring, optional PebbleHost/API recovery, and weekly reports.
